...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { categoria: @curso.categoria, data_conclusao: @curso.data_conclusao, instituicao: @curso.instituicao, nome_curso: @curso.nome_curso } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { categoria: @curso.categoria, data_conclusao: @curso.data_conclusao, instituicao: @curso.instituicao, nome_curso: @curso.nome_curso } }
